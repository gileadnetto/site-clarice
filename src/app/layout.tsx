            ...
            <body className="bg-zinc-0 text-cor-texto" style={{ minHeight: '100vh' }}>
                <div>
                    ...
                    <footer className=' pb-4 bg-zinc-300 flex items-center justify-center align-bottom flex-col'>
                        <div className='my-4 text-center flex  items-center gap-6'>
                            {/* <Image src='/imagens/ime-usp.png' alt="ime-usp imp" width={400} height={300} crossOrigin="anonymous" /> */}

                            <a target="_blank" href='https://www.ime.usp.br/'><Image className="hover:-translate-y-2 transition duration-200 " src='/imagens/ime-logo.png' alt="inctmat logo" width={150} height={40} crossOrigin="anonymous" /></a>
                            <a target="_blank" href='https://www5.usp.br/'><Image className="hover:-translate-y-2 transition duration-200 " src='/imagens/usp-lg.png' alt="inctmat logo" width={130} height={15} crossOrigin="anonymous" /></a>
                            <a target="_blank" href='https://inctmat.impa.br/'><Image className="hover:-translate-y-2 transition duration-200 " src='/imagens/inctmat.png' alt="inctmat logo" width={150} height={40} crossOrigin="anonymous" /></a>
                        </div>

                        <div>
                            <p className='inline-block mx-4 text-cor-principal'><small>Created by Gilead Netto</small></p>
